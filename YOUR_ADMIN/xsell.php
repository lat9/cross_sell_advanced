...
switch($_GET['action']){
  ...
  //  $sort_start = mysqli_fetch_array($sort_start_query);
...
?>
   <tr onMouseOver="cOn(this); this.style.cursor='pointer'; this.style.cursor='hand';" onMouseOut="cOut(this);" bgcolor='#DFE4F4' onClick=document.location.href="<?php echo zen_href_link(FILENAME_XSELL, 'add_related_product_ID=' . $products['products_id'], 'NONSSL');?>">
   ...
   <tr>
    <td colspan="6"><table cellpadding="3" cellspacing="0" border="0" width="100%">
     ...
     <tr class="dataTableHeadingRow">
      ...
      <td align="right" width="5%" valign="bottom"><?php echo zen_image_submit('button_update.gif') . '<br><br><a href="'.zen_href_link(FILENAME_XSELL, 'men_id=catalog').'">' . zen_image_button('button_cancel.gif') . '<br><br>' . zen_image_button('button_back.gif', IMAGE_BACK) . '</a>';?></td>
     </tr>
    </table></td>
   </tr>
     <tr class="dataTableHeadingRow">
...
// while ($products = mysqli_fetch_array($products_query)) {
 ...
 <td class="dataTableContent">&nbsp;<?php echo zen_draw_hidden_field('product[]', $products['products_id']) . zen_draw_checkbox_field('cross[]', $products['products_id'], (($xsold_count > 0) ? true : false), '', ' onMouseOver="this.style.cursor=\'hand\'"');?>&nbsp;<label onMouseOver="this.style.cursor='hand'"><?php echo TEXT_CROSS_SELL;?></label>&nbsp;</td>
   ...
   <tr>
    <td colspan="6"><table cellpadding="3" cellspacing="0" border="0" width="100%">
     ...
     <tr class="dataTableHeadingRow">
      ...
      <td align="right" valign="bottom" width="5%"><?php echo zen_image_submit('button_update.gif') . '<br><br><a href="'.zen_href_link(FILENAME_XSELL, 'men_id=catalog').'">' . zen_image_button('button_cancel.gif') . '</a>';?></td>
     </tr>
    </table></td>
   </tr>
   <tr class="dataTableHeadingRow">
